...
# Install Doppler CLI and other dependencies (apt-transport-https, ca-certificates, curl, gnupg, cmake)
RUN apt-get update && \
    apt-get install -y apt-transport-https ca-certificates curl gnupg cmake && \
